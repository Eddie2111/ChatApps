  ...
  return (
    <footer className='relative py-20 flex flex-col items-center overflow-hidden md:py-40 bg-transparent '>
          ...
          <div className='flex flex-wrap items-center justify-between md:flex-nowrap'>
            <div className='w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start'>
              <ul className='list-disc list-inside space-y-8'>
                <li>
                  <Link href='/' className='text-black dark:text-white hover:text-sky-400 transition'>
                    Home
                  </Link>
                </li>
                <li>
              ...
              <ul role='list' className='space-y-8'>
                <li>
                  <Link
                    href='/'
                    className='flex items-center space-x-3 text-black dark:text-white hover:text-sky-400 transition'
                  >
      ...
      <div aria-hidden='true' className='absolute h-full inset-0 flex items-center'>
        <div
          aria-hidden='true'
          className='bg-layers bg-scale w-56 h-56 m-auto blur-xl bg-gradient-to-r dark:from-purple-800 dark:via-blue-700 dark:to-cyan-600 from-violet-300 via-cyan-300 to-purple-300 rounded-full md:w-[45rem] md:h-[25rem] md:blur-3xl'
        ></div>
      </div>
