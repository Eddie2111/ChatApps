        ...
        <div className='flex justify-center items-center w-screen h-screen bg-white dark:bg-black'>
            <div className='container mx-auto my-4 px-4 lg:px-20'>
                ...
                <div className='w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl dark:shadow-blue-700 hover:dark:shadow-blue-500 duration-300'>
                    ...
                    type='text' placeholder='First Name*' onChange={(e)=>setFirstName(e.target.value)} value={firstName}/>
                        <input className='w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline'
                    type='text' placeholder='Last Name*' onChange={(e)=>setLastName(e.target.value)} value={lastName}/>
                        <input className='w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline'
                    type='email' placeholder='Email*' onChange={(e)=>setEmail(e.target.value)} value={email} />
                        <input className='w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline'
                    type='number' placeholder='Phone*' onChange={(e)=>setPhone(e.target.value)} value={phone} />
                </div>
                        <div className='my-4'>
                            <textarea placeholder='Message*' className='w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline' 
                        ...
                        <div className='my-2 w-1/2 lg:w-1/4'>
                            ...
                            focus:outline-none focus:shadow-outline' onClick={SubmitHandle}>
                    Send Message
                </button>
                        </div>
                    </div>
